...
Begin VB.Form frm_RegLav_02 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "GesOcu_frm_007.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7410
            Picture         =   "GesOcu_frm_007.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Salir"
            Top             =   390
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   585
            Left            =   6810
            Picture         =   "GesOcu_frm_007.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   585
            Left            =   6210
            Picture         =   "GesOcu_frm_007.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   1
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.CommandButton cmd_BusOpe 
            Height          =   585
            Left            =   6810
            Picture         =   "GesOcu_frm_007.frx":0D6C
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_LimOpe 
            Height          =   585
            Left            =   7410
            Picture         =   "GesOcu_frm_007.frx":1076
            Style           =   1  'Graphical
            TabIndex        =   7
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_LimCli 
            Height          =   585
            Left            =   7410
            Picture         =   "GesOcu_frm_007.frx":1380
            Style           =   1  'Graphical
            TabIndex        =   12
         ...
         Begin VB.CommandButton cmd_BusCli 
            Height          =   585
            Left            =   6810
            Picture         =   "GesOcu_frm_007.frx":168A
            Style           =   1  'Graphical
            TabIndex        =   11
   ...
   End
End
Attribute VB_Name = "frm_RegLav_02"
...
Private Sub cmd_Buscar_Click()
   ...
   If g_rst_Princi.BOF And g_rst_Princi.EOF Then
      ...
      Exit Sub
   Else
      modtac_g_int_Moneda = g_rst_Princi!HIPMAE_MONEDA
   End If
